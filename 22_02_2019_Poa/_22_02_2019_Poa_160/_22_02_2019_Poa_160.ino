...
byte mac[] = {0x90, 0xA2, 0xDA, 0x34, 0x62, 0x7B}; //Define MAC da Placa
String ipArduino = "192,168,90,160"; //Define IP da placa
...
void loop() 
{
    ...
    if((porta[2] != digitalRead(2)) || (porta[4] != digitalRead(7)) || (porta[5] != digitalRead(5)) || (porta[6] != digitalRead(6))  || (porta[100] != digitalRead(rele))){
    ...
    if (digitalRead(7) == 0){// Se Porta Automatico está ligada
    ...
    porta[4] = digitalRead(7); //Automatico
        ...
        if(readString.indexOf("status")>0){
          ...
          client.println("<XML>");
            ...
            client.println("<porta>");
              ...
              client.print(" ");
              client.print("<status>");
                client.print(digitalRead(7));//Grava o status da porta como 1
              client.print("</status>");
            client.println("</porta>");
            ...
            client.println("</porta>");
          client.println("</xml>");
          client.println("   Debug Teste POA 160");
        }  
