...
byte mac[] = {0x00,0x3D,0x00,0x0D,0xE2,0xBE}; //Define MAC da Placa
String ipArduino = "192,168,60,153"; //Define IP da placa
...
IPAddress gateway(192,168,60,1); //Define Gateway da placa
...
void loop() 
{
    ...
    if (digitalRead(4) == 1){// Se Porta Automatico está ligada
